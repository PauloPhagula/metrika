...
class MetricsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create metric" do
    assert_difference("Metric.count") do
      post metrics_url, params: { metric: { name: @metric.name, time: @metric.time, value: @metric.value } }
    end
  ...
  test "should update metric" do
    patch metric_url(@metric), params: { metric: { name: @metric.name, time: @metric.time, value: @metric.value } }
